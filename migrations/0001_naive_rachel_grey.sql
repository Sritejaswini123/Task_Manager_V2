...
ALTER TABLE "userTasks" ADD CONSTRAINT "userTasks_project_id_userProjects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."userProjects"("project_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
